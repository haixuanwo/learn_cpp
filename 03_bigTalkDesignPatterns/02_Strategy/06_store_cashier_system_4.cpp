 ...
 * @LastEditors: Clark
 * @LastEditTime: 2024-02-20 15:40:32
...
{
public:
    CashContext(int calculationMethod)
    {
        switch (calculationMethod)
        {
            ...
            case CASH_RETURN:
            {
                ...
                _cs = new CashReturn(moneyCondition, moneyReturn);
                break;
            }
            case CASH_REBATE:
            {
                ...
                double moneyRebate = 1;
                cin>>moneyRebate;
                _cs = new CashRebate(moneyRebate);
                break;
            }
            default:
            {
...
int main()
{
    ...
    while (1)
    {
        ...
        CashContext cc(calculationMethodIndex);
